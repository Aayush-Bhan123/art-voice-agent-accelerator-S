...
from .endpoints import agent_builder, browser, calls, genesys, genesys_debug, health, mcp, media, metrics, scenario_builder, scenarios, sessions
...
v1_router.include_router(genesys_debug.router, prefix="/genesys-debug")
